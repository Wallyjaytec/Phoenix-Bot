...
//____________________________________________________________________________________________________________________________________________  
  SESSION_ID: process.env.SESSION_ID || 'Phoenix~StriveFurnace',
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || 'WALLYJAYTECH-MD;WALLY JAY TECH;https://i.ibb.co/tHWJrz3/IMG-20231128-WA0005.jpg',
  BOT_INFO: process.env.BOT_INFO || 'INVENTED BY WALLY JAY TECH;2348144317152', 
  PREFIX: process.env.PREFIX || ',',
  MODE: process.env.MODE || 'private',
  SUDO: process.env.SUDO || 2348144317152, 2348155763709',
  ...
  RENDER_NAME: process.env.RENDER_NAME || 'wallyjaytech',
  RENDER_API: process.env.RENDER_API || 'rnd_BlCAnwafW9UsAreltxGz0cvFmPD0',
  ...
  AUTO_CALL_REJECT_MSG: process.env.AUTO_CALL_REJECT_MSG || 'Auto call 📞 rejected sir wally is busy right now',
